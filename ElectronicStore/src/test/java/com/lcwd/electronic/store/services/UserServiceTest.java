...
public class UserServiceTest {
    ...
    public void createUserTest(){
        ...
        Assertions.assertEquals("pranav",user1.getName());
    }
...
//        UserDto updatedUser = mapper.map(user,UserDto.class);
        ...
        Assertions.assertEquals(userDto.getName(),updatedUser.getName(),"Name is not validating");
    }
    ...
    public void getAllUserTest(){
      ...
      User user1 = User.builder()
       ...
       User user2 = User.builder()
        ...
        Mockito.when(userRepository.findAll((Pageable) Mockito.any()))
                .thenReturn(page);
    ...
    public void getUserByEmailTest(){
        String emailId="pranav@gmail.com";
